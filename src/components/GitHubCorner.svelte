<script lang="ts">
  ...
  //     openInNewTab : boolean => true :opens in new tab, false: opens in same tab
  //     color: Color : white, black, green, red, blue => indicates color of badge
...
{#if side === 'left'}
  <a
    ...
    <svg width="80" height="80" viewBox="0 0 250 250" class={`${color} ${side}`} aria-hidden="true">
